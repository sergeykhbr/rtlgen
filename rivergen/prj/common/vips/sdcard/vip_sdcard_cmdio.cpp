...
vip_sdcard_cmdio::vip_sdcard_cmdio(GenObject *parent, const char *name, const char *comment) :
    ...
    CMDSTATE_REQ_STARTBIT(this, "CMDSTATE_REQ_STARTBIT", "4", "0", NO_COMMENT),
    CMDSTATE_REQ_TXBIT(this, "CMDSTATE_REQ_TXBIT", "4", "1", NO_COMMENT),
    CMDSTATE_REQ_CMD(this, "CMDSTATE_REQ_CMD", "4", "2", NO_COMMENT),
    CMDSTATE_REQ_ARG(this, "CMDSTATE_REQ_ARG", "4", "3", NO_COMMENT),
    CMDSTATE_REQ_CRC7(this, "CMDSTATE_REQ_CRC7", "4", "4", NO_COMMENT),
    CMDSTATE_REQ_STOPBIT(this, "CMDSTATE_REQ_STOPBIT", "4", "5", NO_COMMENT),
    CMDSTATE_REQ_VALID(this, "CMDSTATE_REQ_VALID", "4", "6", NO_COMMENT),
    CMDSTATE_WAIT_RESP(this, "CMDSTATE_WAIT_RESP", "4", "7", NO_COMMENT),
    CMDSTATE_RESP(this, "CMDSTATE_RESP", "4", "8", NO_COMMENT),
    ...
    CMDSTATE_INIT(this, "CMDSTATE_INIT", "4", "15", NO_COMMENT),
    // signals
    ...
    // registers
    clkcnt(this, "clkcnt", "8", "'0", NO_COMMENT),
    cs(this, "cs", "1"),
    spi_mode(this, "spi_mode", "1"),
    cmdz(this, "cmdz", "1", "1"),
    cmd_dir(this, "cmd_dir", "1", "1"),
    cmd_rxshift(this, "cmd_rxshift", "48", "'1", NO_COMMENT),
    cmd_txshift(this, "cmd_txshift", "48", "'1", NO_COMMENT),
    cmd_state(this, "cmd_state", "4", "CMDSTATE_INIT", NO_COMMENT),
    cmd_req_crc_err(this, "cmd_req_crc_err", "1"),
    bitcnt(this, "bitcnt", "6", "'0", NO_COMMENT),
    txbit(this, "txbit", "1"),
    ...
    cmd_req_data(this, "cmd_req_data", "32", "'0", NO_COMMENT),
