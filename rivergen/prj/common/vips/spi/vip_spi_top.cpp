...
vip_spi_top::vip_spi_top(GenObject *parent, const char *name, const char *comment) :
    ...
    scratch0(this, "scratch0", "32", "'0", NO_COMMENT),
    scratch1(this, "scratch1", "32", "'0", NO_COMMENT),
    scratch2(this, "scratch2", "32", "'0", NO_COMMENT),
    uart_loopback(this, "uart_loopback", "1"),
    gpio_out(this, "gpio_out", "16", "'0", NO_COMMENT),
    gpio_dir(this, "gpio_dir", "16", "'0", NO_COMMENT),
    //
