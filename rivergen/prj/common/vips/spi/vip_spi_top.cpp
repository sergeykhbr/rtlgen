...
vip_spi_top::vip_spi_top(GenObject *parent, const char *name, const char *comment) :
    ...
    // registers
    resp_valid(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "resp_valid", "1", RSTVAL_ZERO, NO_COMMENT),
    resp_rdata(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "resp_rdata", "32", "'0", NO_COMMENT),
    scratch0(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "scratch0", "32", "'0", NO_COMMENT),
    scratch1(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "scratch1", "32", "'0", NO_COMMENT),
    scratch2(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "scratch2", "32", "'0", NO_COMMENT),
    uart_loopback(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "uart_loopback", "1", RSTVAL_ZERO, NO_COMMENT),
    gpio_out(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "gpio_out", "16", "'0", NO_COMMENT),
    gpio_dir(this, &w_clk, CLK_POSEDGE, &i_nrst, ACTIVE_LOW, "gpio_dir", "16", "'0", NO_COMMENT),
    //
