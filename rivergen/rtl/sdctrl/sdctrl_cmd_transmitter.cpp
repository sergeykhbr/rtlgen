...
sdctrl_cmd_transmitter::sdctrl_cmd_transmitter(GenObject *parent, const char *name, const char *comment) :
    ...
    CMDSTATE_IDLE(this, "CMDSTATE_IDLE", "4", "0", NO_COMMENT),
    CMDSTATE_REQ_CONTENT(this, "CMDSTATE_REQ_CONTENT", "4", "1", NO_COMMENT),
    CMDSTATE_REQ_CRC7(this, "CMDSTATE_REQ_CRC7", "4", "2", NO_COMMENT),
    CMDSTATE_REQ_STOPBIT(this, "CMDSTATE_REQ_STOPBIT", "4", "3", NO_COMMENT),
    CMDSTATE_RESP_WAIT(this, "CMDSTATE_RESP_WAIT", "4", "4", NO_COMMENT),
    CMDSTATE_RESP_TRANSBIT(this, "CMDSTATE_RESP_TRANSBIT", "4", "5", NO_COMMENT),
    CMDSTATE_RESP_CMD_MIRROR(this, "CMDSTATE_RESP_CMD_MIRROR", "4", "6", NO_COMMENT),
    CMDSTATE_RESP_REG(this, "CMDSTATE_RESP_REG", "4", "7", NO_COMMENT),
    CMDSTATE_RESP_CID_CSD(this, "CMDSTATE_RESP_CID_CSD", "4", "8", NO_COMMENT),
    CMDSTATE_RESP_CRC7(this, "CMDSTATE_RESP_CRC7", "4", "9", NO_COMMENT),
    CMDSTATE_RESP_STOPBIT(this, "CMDSTATE_RESP_STOPBIT", "4", "10", NO_COMMENT),
    CMDSTATE_RESP_SPI_R1(this, "CMDSTATE_RESP_SPI_R1", "4", "11", NO_COMMENT),
    CMDSTATE_RESP_SPI_R2(this, "CMDSTATE_RESP_SPI_R2", "4", "12", NO_COMMENT),
    CMDSTATE_RESP_SPI_DATA(this, "CMDSTATE_RESP_SPI_DATA", "4", "13", NO_COMMENT),
    CMDSTATE_PAUSE(this, "CMDSTATE_PAUSE", "4", "15", NO_COMMENT),
    // signals
    wb_crc7(this, "wb_crc7", "7"),
    w_crc7_next(this, "w_crc7_next", "1"),
    w_crc7_dat(this, "w_crc7_dat", "1"),
    // registers
    req_cmd(this, "req_cmd", "6", "'0", NO_COMMENT),
    req_rn(this, "req_rn", "3", "'0", NO_COMMENT),
    resp_valid(this, "resp_valid", "1"),
    resp_cmd(this, "resp_cmd", "6", "'0", NO_COMMENT),
    resp_reg(this, "resp_arg", "32", "'0", NO_COMMENT),
    resp_spistatus(this, "resp_spistatus", "15", "'0", NO_COMMENT),
    cmdshift(this, "cmdshift", "40", "'1" NO_COMMENT),
    cmdmirror(this, "cmdmirror", "6", "'0", NO_COMMENT),
    regshift(this, "regshift", "32", "'0", NO_COMMENT),
    cidshift(this, "cidshift", "120", "'0", NO_COMMENT),
    crc_calc(this, "crc_calc", "7", "'0", NO_COMMENT),
    crc_rx(this, "crc_rx", "7", "'0", NO_COMMENT),
    cmdbitcnt(this, "cmdbitcnt", "7", "'0", NO_COMMENT),
    crc7_clear(this, "crc7_clear", "1", "1"),
    cmdstate(this, "cmdstate", "4", "CMDSTATE_IDLE", NO_COMMENT),
    err_valid(this, "err_valid", "1"),
    err_setcode(this, "err_setcode", "4", "CMDERR_NONE", NO_COMMENT),
