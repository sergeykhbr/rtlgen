...
sdctrl_sdmode::sdctrl_sdmode(GenObject *parent, const char *name) :
    ModuleObject(parent, "sdctrl_sdmode", name),
    ...
    crc16_calc1(this, "crc16_calc1", "16"),
    crc16_calc2(this, "crc16_calc2", "16"),
    crc16_calc3(this, "crc16_calc3", "16"),
    crc16_rx0(this, "crc16_rx0", "16"),
    crc16_rx1(this, "crc16_rx1", "16"),
    crc16_rx2(this, "crc16_rx2", "16"),
    crc16_rx3(this, "crc16_rx3", "16"),
