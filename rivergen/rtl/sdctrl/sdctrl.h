    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) :
            ...
            vb_cmd_req_cmd(this, "vb_cmd_req_cmd", "6", "'0", NO_COMMENT),
            vb_cmd_req_arg(this, "vb_cmd_req_arg", "32", "'0", NO_COMMENT),
            vb_cmd_req_rn(this, "vb_cmd_req_rn", "3", "'0", NO_COMMENT),
            v_req_sdmem_ready(this, "v_req_sdmem_ready", "1"),
            v_resp_sdmem_valid(this, "v_resp_sdmem_valid", "1"),
            vb_resp_sdmem_data(this, "vb_resp_sdmem_data", "512", "'0", NO_COMMENT),
            v_err_valid(this, "v_err_valid", "1"),
            v_err_clear(this, "v_err_clear", "1"),
            vb_err_setcode(this, "vb_err_setcode", "4", "'0", NO_COMMENT),
            v_400kHz_ena(this, "v_400kHz_ena", "1", "1"),
            vb_sdtype(this, "vb_sdtype", "3", "'0", NO_COMMENT),
