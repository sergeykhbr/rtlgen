...
types_pnp::types_pnp(GenObject *parent) :
    ...
    OPTIMITECH_SDCTRL_REG(this, "16", "OPTIMITECH_SDCTRL_REG", "0x0089"),
    _didslv16_(this, "SD-card controller memory"),
    OPTIMITECH_SDCTRL_MEM(this, "16", "OPTIMITECH_SDCTRL_MEM", "0x008b"),
    ...
    SOC_PNP_SDCTRL_REG(this, "SOC_PNP_SDCTRL_REG", "14"),
    SOC_PNP_SDCTRL_MEM(this, "SOC_PNP_SDCTRL_MEM", "15"),
    SOC_PNP_TOTAL(this, "SOC_PNP_TOTAL", "16"),
    _pnp2_(this),
