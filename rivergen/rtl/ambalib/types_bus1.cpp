...
types_bus1::types_bus1(GenObject *parent) :
    ...
    CFG_BUS1_PSLV_SDCTRL_REG(this, "CFG_BUS1_PSLV_SDCTRL_REG", "3"),
    ...
    _vec0_(this),
    bus1_apb_in_vector_def_(this, "apb_in_type"),
    bus1_apb_out_vector_def_(this, "apb_out_type"),
    bus1_mapinfo_vector_def_(this, "mapinfo_type"),
    _map0_(this),
