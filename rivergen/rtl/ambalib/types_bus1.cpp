...
types_bus1::types_bus1(GenObject *parent) :
    ...
    _pslv8_(this, "Configuration index of the GPIO (General Purpose In/Out) module."),
    CFG_BUS1_PSLV_GPIO(this, "CFG_BUS1_PSLV_GPIO", "3"),
    _pslv9_(this, "@brief DDR control register."),
    CFG_BUS1_PSLV_DDR(this, "CFG_BUS1_PSLV_DDR", "4"),
    _xslv10_(this, "Configuration index of the Plug-n-Play module."),
    CFG_BUS1_PSLV_PNP(this, "CFG_BUS1_PSLV_PNP", "5"),
    _pslv11_(this, "Total number of the APB slaves devices on Bus[1]."),
    CFG_BUS1_PSLV_TOTAL(this, "CFG_BUS1_PSLV_TOTAL", "6"),
    _vec0_(this),
