...
types_bus0::types_bus0(GenObject *parent) :
    ...
    CFG_BUS0_XSLV_BOOTROM(this, "CFG_BUS0_XSLV_BOOTROM", autoincr_++),
    _xslv8_(this, "Configuration index of the Core Local Interrupt Controller module."),
    CFG_BUS0_XSLV_CLINT(this, "CFG_BUS0_XSLV_CLINT", autoincr_++),
    _xslv9_(this, "Configuration index of the SRAM module visible by the firmware."),
    CFG_BUS0_XSLV_SRAM(this, "CFG_BUS0_XSLV_SRAM", autoincr_++),
    _xslv10_(this, "Configuration index of the External Controller module."),
    CFG_BUS0_XSLV_PLIC(this, "CFG_BUS0_XSLV_PLIC", autoincr_++),
    _xslv11_(this, "Configuration index of the APB Bridge."),
    CFG_BUS0_XSLV_PBRIDGE(this, "CFG_BUS0_XSLV_PBRIDGE", autoincr_++),
    _xslv12_(this, "External DDR"),
    CFG_BUS0_XSLV_DDR(this, "CFG_BUS0_XSLV_DDR", autoincr_++),
#if GENCFG_SD_CTRL_ENABLE
    _xslv13_(this, "SD-card direct memory access."),
    CFG_BUS0_XSLV_SDCTRL_MEM(this, "CFG_BUS0_XSLV_SDCTRL_MEM", autoincr_++),
#endif
    _xslv14_(this, "Total number of the slaves devices."),
    CFG_BUS0_XSLV_TOTAL(this, "CFG_BUS0_XSLV_TOTAL", autoincr_),
