...
types_bus0::types_bus0(GenObject *parent) :
    ...
    _xslv8_(this, "Configuration index of the SRAM module visible by the firmware."),
    CFG_BUS0_XSLV_SRAM(this, "CFG_BUS0_XSLV_SRAM", "1"),
    ...
    CFG_BUS0_XSLV_CLINT(this, "CFG_BUS0_XSLV_CLINT", "5"),
    _xslv13_(this, "Configuration index of the External Controller module."),
    CFG_BUS0_XSLV_PLIC(this, "CFG_BUS0_XSLV_PLIC", "6"),
    _xslv14_(this, "Configuration index of the Plug-n-Play module."),
    CFG_BUS0_XSLV_PNP(this, "CFG_BUS0_XSLV_PNP", "7"),
    _xslv15_(this, "Total number of the slaves devices."),
    CFG_BUS0_XSLV_TOTAL(this, "CFG_BUS0_XSLV_TOTAL", "8"),
    _vec0_(this),
