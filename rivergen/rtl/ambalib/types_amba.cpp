...
types_amba::types_amba(GenObject *parent) :
    ...
    SLV_DID_EMPTY(this, "16", "SLV_DID_EMPTY", "5577"),
    _pnpcfg0_(this),
    ...
    _xslvcfg0_(this),
    _xslvcfg1_(this, "@brief   Plug-n-play descriptor structure for slave device."),
    _xslvcfg2_(this, "@details Each slave device must generates this datatype output that"),
    _xslvcfg3_(this, "         is connected directly to the 'pnp' slave module on system bus."),
    axi4_slave_config_type_def_(this, ""),
    _xslvcfg4_(this),
    _xslvcfg5_(this, "@brief Default slave config value."),
    axi4_slave_config_none(this, "axi4_slave_config_none"),
    _xmstcfg0_(this),
    _xmstcfg1_(this, "@brief   Plug-n-play descriptor structure for master device."),
    _xmstcfg2_(this, "@details Each slave device must generates this datatype output that"),
    _xmstcfg3_(this, "         is connected directly to the 'pnp' master module on system bus."),
