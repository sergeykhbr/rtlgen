...
types_river::types_river(GenObject *parent) :
    ...
    _dbgiface6_(this),
    dport_in_vector_def_(this, "dport_in_type"),
    dport_out_vector_def_(this, "dport_out_type"),
    _dbgiface7_(this),
    ...
    _axi5_(this),
    axi4_l1_in_vector_def_(this, "axi4_l1_in_type"),
    axi4_l1_out_vector_def_(this, "axi4_l1_out_type"),
    _axi6_(this),
