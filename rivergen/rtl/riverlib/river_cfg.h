...
class river_cfg : public FileObject {
 ...
 public:
    ...
    TextLine _csr2_;
    TextLine _csr3_;
    ParamUI16D CSR_fflags;
    TextLine _csr4_;
    ParamUI16D CSR_frm;
    TextLine _csr5_;
    ParamUI16D CSR_fcsr;
    TextLine _csr6_;
    ParamUI16D CSR_mstatus;
    TextLine _csr7_;
    ParamUI16D CSR_misa;
    TextLine _csr8_;
    ParamUI16D CSR_medeleg;
    TextLine _csr9_;
    ParamUI16D CSR_mideleg;
    TextLine _csr10_;
    ParamUI16D CSR_mie;
    TextLine _csr11_;
    ParamUI16D CSR_mtvec;
    TextLine _csr12_;
    ParamUI16D CSR_mscratch;
    TextLine _csr13_;
    ParamUI16D CSR_uepc;
    ParamUI16D CSR_sepc;
    TextLine _csr14_;
    ...
    ParamUI16D CSR_mepc;
    TextLine _csr15_;
    ParamUI16D CSR_mcause;
    TextLine _csr16_;
    ParamUI16D CSR_mtval;
    TextLine _csr17_;
    ParamUI16D CSR_mip;
    TextLine _csr18_;
    ParamUI16D CSR_mreset;
    TextLine _csr19_;
    ParamUI16D CSR_tselect;
    TextLine _csr20_;
    ParamUI16D CSR_tdata1;
    TextLine _csr21_;
    ParamUI16D CSR_tdata2;
    TextLine _csr22_;
    ParamUI16D CSR_textra;
    TextLine _csr23_;
    ParamUI16D CSR_tinfo;
    TextLine _csr24_;
    ParamUI16D CSR_tcontrol;
    TextLine _csr25_;
    ParamUI16D CSR_mcontext;
    TextLine _csr26_;
    ParamUI16D CSR_scontext;
    TextLine _csr27_;
    ParamUI16D CSR_dcsr;
    TextLine _csr28_;
    ParamUI16D CSR_dpc;
    TextLine _csr29_;
    ParamUI16D CSR_dscratch0;
    TextLine _csr30_;
    ParamUI16D CSR_dscratch1;
    TextLine _csr31_;
    TextLine _csr32_;
    ParamUI16D CSR_flushi;
    TextLine _csr33_;
    TextLine _csr34_;
    TextLine _csr35_;
    ParamUI16D CSR_mcycle;
    TextLine _csr36_;
    ParamUI16D CSR_minsret;
    TextLine _csr37_;
    TextLine _csr38_;
    TextLine _csr39_;
    ParamUI16D CSR_mstackovr;
    TextLine _csr40_;
    ParamUI16D CSR_mstackund;
    TextLine _csr41_;
    ParamUI16D CSR_mpu_addr;
    TextLine _csr42_;
    ParamUI16D CSR_mpu_mask;
    TextLine _csr43_;
    ParamUI16D CSR_mpu_ctrl;
    TextLine _csr44_;
    TextLine _csr45_;
    ParamUI16D CSR_cycle;
    TextLine _csr46_;
    ParamUI16D CSR_time;
    TextLine _csr47_;
    ParamUI16D CSR_insret;
    TextLine _csr48_;
    TextLine _csr49_;
    ParamUI16D CSR_mvendorid;
    TextLine _csr50_;
    ParamUI16D CSR_marchid;
    TextLine _csr51_;
    ParamUI16D CSR_mimplementationid;
    TextLine _csr52_;
    ParamUI16D CSR_mhartid;
    TextLine _csr53_;
    TextLine _dport0_;
    TextLine _dport1_;
    ...
    TextLine _dport2_;
    TextLine _dport3_;
    ParamUI32D HALT_CAUSE_EBREAK;
    ParamUI32D HALT_CAUSE_TRIGGER;
    ParamUI32D HALT_CAUSE_HALTREQ;
    ParamUI32D HALT_CAUSE_STEP;
    ParamUI32D HALT_CAUSE_RESETHALTREQ;
    TextLine _dport4_;
    ParamUI32D PROGBUF_ERR_NONE;
    ParamUI32D PROGBUF_ERR_BUSY;
    ParamUI32D PROGBUF_ERR_NOT_SUPPORTED;
    ParamUI32D PROGBUF_ERR_EXCEPTION;
    ParamUI32D PROGBUF_ERR_HALT_RESUME;
    ParamUI32D PROGBUF_ERR_BUS;
    ParamUI32D PROGBUF_ERR_OTHER;
    TextLine _prv0_;
    TextLine _prv1_;
    TextLine _prv3_;
    TextLine _prv4_;
