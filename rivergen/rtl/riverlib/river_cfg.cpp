...
river_cfg::river_cfg(GenObject *parent) :
    ...
    ISA_R_type(this, "6", "ISA_R_type", "POW2(1,0)"),
    ISA_I_type(this, "6", "ISA_I_type", "POW2(1,1)"),
    ISA_S_type(this, "6", "ISA_S_type", "POW2(1,2)"),
    ISA_SB_type(this, "6", "ISA_SB_type", "POW2(1,3)"),
    ISA_U_type(this, "6", "ISA_U_type", "POW2(1,4)"),
    ISA_UJ_type(this, "6", "ISA_UJ_type", "POW2(1,5)"),
    ISA_Total(this, "6", "ISA_Total", "POW2(1,6)"),
    _IsaType2_(this),
