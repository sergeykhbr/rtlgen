...
river_cfg::river_cfg(GenObject *parent) :
    ...
    CFG_RESET_VECTOR(this, "CFG_RESET_VECTOR", "CFG_CPU_ADDR_BITS", "0x10000", NO_COMMENT),
    _9_(this),
    _bp0_(this, ""),
    ...
    CFG_DMI_TAP_ID(this, "CFG_DMI_TAP_ID", "32", "0x10e31913", NO_COMMENT),
    _17_(this),
    ...
    _mop0_(this),
    _mop1_(this),
    MEMOP_8B(this, "MEMOP_8B", "2", "3", NO_COMMENT),
    MEMOP_4B(this, "MEMOP_4B", "2", "2", NO_COMMENT),
    MEMOP_2B(this, "MEMOP_2B", "2", "1", NO_COMMENT),
    MEMOP_1B(this, "MEMOP_1B", "2", "0", NO_COMMENT),
    _72_(this),
    ...
    PRV_U(this, "PRV_U", "2", "0", NO_COMMENT),
    _prv5_(this, "super-visor mode"),
    PRV_S(this, "PRV_S", "2", "1", NO_COMMENT),
    _prv6_(this, "hyper-visor mode"),
    PRV_H(this, "PRV_H", "2", "2", NO_COMMENT),
    _prv7_(this, "machine mode"),
    PRV_M(this, "PRV_M", "2", "3", NO_COMMENT),
    _prv8_(this, "@}"),
    _dport0_(this),
    ...
    HALT_CAUSE_EBREAK(this, "HALT_CAUSE_EBREAK", "3", "1", "software breakpoint"),
    HALT_CAUSE_TRIGGER(this, "HALT_CAUSE_TRIGGER", "3", "2", "hardware breakpoint"),
    HALT_CAUSE_HALTREQ(this, "HALT_CAUSE_HALTREQ", "3", "3", "halt request via debug interface"),
    HALT_CAUSE_STEP(this, "HALT_CAUSE_STEP", "3", "4", "step done"),
    HALT_CAUSE_RESETHALTREQ(this, "HALT_CAUSE_RESETHALTREQ", "3", "5", "not implemented"),
    _dport4_(this),
    PROGBUF_ERR_NONE(this, "PROGBUF_ERR_NONE", "3", "0", "no error"),
    PROGBUF_ERR_BUSY(this, "PROGBUF_ERR_BUSY", "3", "1", "abstract command in progress"),
    PROGBUF_ERR_NOT_SUPPORTED(this, "PROGBUF_ERR_NOT_SUPPORTED", "3", "2", "Request command not supported"),
    PROGBUF_ERR_EXCEPTION(this, "PROGBUF_ERR_EXCEPTION", "3", "3", "Exception occurs while executing progbuf"),
    PROGBUF_ERR_HALT_RESUME(this, "PROGBUF_ERR_HALT_RESUME", "3", "4", "Command cannot be executed because of wrong CPU state"),
    PROGBUF_ERR_BUS(this, "PROGBUF_ERR_BUS", "3", "5", "Bus error occurs"),
    PROGBUF_ERR_OTHER(this, "PROGBUF_ERR_OTHER", "3", "7", "Other reason"),
    _expt0_(this),
    ...
    _83_(this),
    CsrReq_ReadCmd(this, "CsrReq_ReadCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_ReadBit)", NO_COMMENT),
    CsrReq_WriteCmd(this, "CsrReq_WriteCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_WriteBit)", NO_COMMENT),
    CsrReq_TrapReturnCmd(this, "CsrReq_TrapReturnCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_TrapReturnBit)", NO_COMMENT),
    CsrReq_ExceptionCmd(this, "CsrReq_ExceptionCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_ExceptionBit)", NO_COMMENT),
    CsrReq_InterruptCmd(this, "CsrReq_InterruptCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_InterruptBit)", NO_COMMENT),
    CsrReq_BreakpointCmd(this, "CsrReq_BreakpointCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_BreakpointBit)", NO_COMMENT),
    CsrReq_HaltCmd(this, "CsrReq_HaltCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_HaltBit)", NO_COMMENT),
    CsrReq_ResumeCmd(this, "CsrReq_ResumeCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_ResumeBit)", NO_COMMENT),
    CsrReq_WfiCmd(this, "CsrReq_WfiCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_WfiBit)", NO_COMMENT),
    CsrReq_FenceCmd(this, "CsrReq_FenceCmd", "CsrReq_TotalBits", "POW2(1,CsrReq_FenceBit)", NO_COMMENT),
    _84_(this),
