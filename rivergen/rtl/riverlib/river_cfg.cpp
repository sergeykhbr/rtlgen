...
river_cfg::river_cfg(GenObject *parent) :
    ...
    _72_(this),
    _73_(this, "Depth of the fifo between Executor and MemoryAccess modules."),
    CFG_MEMACCESS_QUEUE_DEPTH(this, "CFG_MEMACCESS_QUEUE_DEPTH", new I32D("2")),
    _74_(this, "Register's tag used to detect reg hazard and it should be higher than available"),
    _75_(this, "slots in the fifo Executor => Memaccess."),
    CFG_REG_TAG_WIDTH(this, "CFG_REG_TAG_WIDTH", new I32D("3")),
    _76_(this),
    _77_(this, "Request type: [0]-read csr; [1]-write csr; [2]-change mode"),
    ...
    _78_(this),
    CsrReq_ReadCmd(this, "CsrReq_ReadCmd", new I32D("POW2(1,CsrReq_ReadBit)")),
    CsrReq_WriteCmd(this, "CsrReq_WriteCmd", new I32D("POW2(1,CsrReq_WriteBit)")),
    CsrReq_TrapReturnCmd(this, "CsrReq_TrapReturnCmd", new I32D("POW2(1,CsrReq_TrapReturnBit)")),
    CsrReq_ExceptionCmd(this, "CsrReq_ExceptionCmd", new I32D("POW2(1,CsrReq_ExceptionBit)")),
    CsrReq_InterruptCmd(this, "CsrReq_InterruptCmd", new I32D("POW2(1,CsrReq_InterruptBit)")),
    CsrReq_BreakpointCmd(this, "CsrReq_BreakpointCmd", new I32D("POW2(1,CsrReq_BreakpointBit)")),
    CsrReq_HaltCmd(this, "CsrReq_HaltCmd", new I32D("POW2(1,CsrReq_HaltBit)")),
    CsrReq_ResumeCmd(this, "CsrReq_ResumeCmd", new I32D("POW2(1,CsrReq_ResumeBit)")),
    CsrReq_WfiCmd(this, "CsrReq_WfiCmd", new I32D("POW2(1,CsrReq_WfiBit)")),
    _79_(this),
