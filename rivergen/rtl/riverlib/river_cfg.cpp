...
river_cfg::river_cfg(GenObject *parent) :
    ...
    IRQ_HART_SSIP(this, "IRQ_HART_SSIP", "1", "Supervisor software pening interrupt"),
    IRQ_HART_MSIP(this, "IRQ_HART_MSIP", "3", "Machine software pening interrupt"),
    IRQ_HART_STIP(this, "IRQ_HART_STIP", "5", "Supervisor timer pening interrupt"),
    IRQ_HART_MTIP(this, "IRQ_HART_MTIP", "7", "Machine timer pening interrupt"),
    IRQ_HART_SEIP(this, "IRQ_HART_SEIP", "9", "Supervisor external pening interrupt"),
    IRQ_HART_MEIP(this, "IRQ_HART_MEIP", "11", "Machine external pening interrupt"),
    IRQ_PER_HART_TOTAL(this, "IRQ_PER_HART_TOTAL", "12", "Total number of direct core interrupt requests"),
