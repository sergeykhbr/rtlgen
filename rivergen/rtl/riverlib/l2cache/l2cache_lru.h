    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) :
            ...
            vb_cache_line_i_modified(this, "vb_cache_line_i_modified", "L2CACHE_LINE_BITS"),
            vb_line_rdata_o_modified(this, "vb_line_rdata_o_modified", "L2CACHE_LINE_BITS"),
            vb_line_rdata_o_wstrb(this, "vb_line_rdata_o_wstrb", "L2CACHE_BYTES_PER_LINE"),
            v_req_ready(this, "v_req_ready", "1"),
            t_cache_line_i(this, "t_cache_line_i", "L2CACHE_LINE_BITS"),
            vb_cached_data(this, "vb_cached_data", "L1CACHE_LINE_BITS"),
            vb_uncached_data(this, "vb_uncached_data", "L1CACHE_LINE_BITS"),
            v_resp_valid(this, "v_resp_valid", "1"),
            vb_resp_rdata(this, "vb_resp_rdata", "L1CACHE_LINE_BITS"),
            vb_resp_status(this, "vb_resp_status", "L2_REQ_TYPE_BITS"),
            ...
            vb_req_mask(this, "vb_req_mask", "L1CACHE_LINE_BITS"),
            v_line_wflags(this, "v_line_wflags", "L2TAG_FL_TOTAL"),
            ridx("0", "ridx", this),
