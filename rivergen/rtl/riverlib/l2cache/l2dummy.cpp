...
TEXT();
    ...
    CASE(state_r);
        ...
        ENDCASE();
    CASE(l1_r_resp);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_valid,CONST("1", 1));
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_last, CONST("1", 1));
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_data, rdata);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_resp, CC2(CONST("0", 2), resp));
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_id, req_id);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->r_user, req_user);
        IF (NZ(ARRITEM(comb.vl1o, srcid, comb.vl1o->r_ready)));
            SETVAL(state, Idle);
        ENDIF();
        ENDCASE();
    CASE(state_aw);
    ...
    CASE(state_b);
        ...
        ENDCASE();
    CASE(l1_w_resp);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->b_valid, CONST("1", 1));
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->b_resp, resp);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->b_id, req_id);
        SETARRITEM(comb.vlxi, srcid, comb.vlxi->b_user, req_user);
        IF (NZ(ARRITEM(comb.vl1o, srcid, comb.vl1o->b_ready)));
            SETVAL(state, Idle);
        ENDIF();
        ENDCASE();
    CASEDEF();
