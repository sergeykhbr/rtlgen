...
ICacheLru::ICacheLru(GenObject *parent, const char *name, const char *comment) :
    ...
    FLUSH_ALL_VALUE(this, "FLUSH_ALL_VALUE", "32", "SUB(POW2(1,ADD(CFG_ILOG2_LINES_PER_WAY,CFG_ILOG2_NWAYS)),1)", "Actual bitwidth is (ibits + waybits) but to avoid sc template generation use 32-bits"),
    // signals
    ...
    req_addr_next(this, "req_addr_next", "CFG_CPU_ADDR_BITS", "'0", NO_COMMENT),
    write_addr(this, "write_addr", "CFG_CPU_ADDR_BITS", "'0", NO_COMMENT),
    ...
    cache_line_i(this, "cache_line_i", "L1CACHE_LINE_BITS", "'0", NO_COMMENT),
    // process
    comb(this),
    mem0(this, "mem0")
{
