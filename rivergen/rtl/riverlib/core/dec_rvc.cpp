...
DecoderRvc::DecoderRvc(GenObject *parent, const char *name, const char *depth) :
    ...
    // param
    OPCODE_C_ADDI4SPN(this, "5", "OPCODE_C_ADDI4SPN", "0x00"),
    OPCODE_C_NOP_ADDI(this, "5", "OPCODE_C_NOP_ADDI", "0x01"),
    OPCODE_C_SLLI(this, "5", "OPCODE_C_SLLI", "0x02"),
    OPCODE_C_JAL_ADDIW(this, "5", "OPCODE_C_JAL_ADDIW", "0x05"),
    OPCODE_C_LW(this, "5", "OPCODE_C_LW", "0x08"),
    OPCODE_C_LI(this, "5", "OPCODE_C_LI", "0x09"),
    OPCODE_C_LWSP(this, "5", "OPCODE_C_LWSP", "0x0A"),
    OPCODE_C_LD(this, "5", "OPCODE_C_LD", "0x0C"),
    OPCODE_C_ADDI16SP_LUI(this, "5", "OPCODE_C_ADDI16SP_LUI", "0xD"),
    OPCODE_C_LDSP(this, "5", "OPCODE_C_LDSP", "0x0E"),
    OPCODE_C_MATH(this, "5", "OPCODE_C_MATH", "0x11"),
    OPCODE_C_JR_MV_EBREAK_JALR_ADD(this, "5", "OPCODE_C_JR_MV_EBREAK_JALR_ADD", "0x12"),
    OPCODE_C_J(this, "5", "OPCODE_C_J", "0x15"),
    OPCODE_C_SW(this, "5", "OPCODE_C_SW", "0x18"),
    OPCODE_C_BEQZ(this, "5", "OPCODE_C_BEQZ", "0x19"),
    OPCODE_C_SWSP(this, "5", "OPCODE_C_SWSP", "0x1A"),
    OPCODE_C_SD(this, "5", "OPCODE_C_SD", "0x1C"),
    OPCODE_C_BNEZ(this, "5", "OPCODE_C_BNEZ", "0x1D"),
