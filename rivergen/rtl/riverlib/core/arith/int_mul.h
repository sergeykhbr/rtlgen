...
class IntMul : public ModuleObject {
    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) :
            ...
            wb_lvl0(this, "wb_lvl0", "66", "32", NO_COMMENT),
            wb_lvl2(this, "wb_lvl2", "74", "8", NO_COMMENT),
            wb_lvl4(this, "wb_lvl4", "100", "2", NO_COMMENT),
 ...
 protected:
     class MulLevel1Type : public RegArray {
      public:
        MulLevel1Type(GenObject *parent,
                      Logic *clk,
                      Logic *rstn,
                      const char *name,
                      const char *width,
     ...
     class MulLevel3Type : public RegArray {
      public:
        MulLevel3Type(GenObject *parent,
                      Logic *clk,
                      Logic *rstn,
                      const char *name,
                      const char *width,
