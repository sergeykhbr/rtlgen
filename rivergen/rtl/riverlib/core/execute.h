...
class input_mux_type : public StructObject {
 public:
    ...
    f64(this, "f64", "1"),
    ivec(this, "ivec", "Instr_Total", "'0", NO_COMMENT),
    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) : ProcObject(parent, "comb"),
            ...
            vb_csr_cmd_wdata(this, "vb_csr_cmd_wdata", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_res(this, "vb_res", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_prog_npc(this, "vb_prog_npc", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_npc_incr(this, "vb_npc_incr", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_off(this, "vb_off", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_sub64(this, "vb_sub64", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_memop_memaddr(this, "vb_memop_memaddr", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_memop_memaddr_load(this, "vb_memop_memaddr_load", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_memop_memaddr_store(this, "vb_memop_memaddr_store", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_memop_wdata(this, "vb_memop_wdata", "RISCV_ARCH", "'0", NO_COMMENT),
            wv(this, "wv", "Instr_Total"),
            opcode_len(this, "opcode_len", "3", "'0", NO_COMMENT),
            ...
            vb_rdata1_amo(this, "vb_rdata1_amo", "RISCV_ARCH", "'0", NO_COMMENT),
            v_check_tag1(this, "v_check_tag1", "1"),
            v_check_tag2(this, "v_check_tag2", "1"),
            vb_select(this, "vb_select", "Res_Total", "'0", NO_COMMENT),
            ...
            vb_reg_waddr(this, "vb_reg_waddr", "6", "'0", NO_COMMENT),
            ...
            vb_csr_cmd_addr(this, "vb_csr_cmd_addr", "12", "'0", NO_COMMENT),
            vb_csr_cmd_type(this, "vb_csr_cmd_type", "CsrReq_TotalBits", "'0", NO_COMMENT),
            ...
            vb_o_npc(this, "vb_o_npc", "RISCV_ARCH", "'0", NO_COMMENT),
            t_radr1(this, "t_radr1", "0", NO_COMMENT),
            t_radr2(this, "t_radr2", "0", NO_COMMENT),
            t_waddr(this, "t_waddr", "0", NO_COMMENT),
            t_type(this, "t_type", "MemopType_Total", "'0", NO_COMMENT),
            t_tagcnt_wr(this, "t_tagcnt_wr", "CFG_REG_TAG_WIDTH", "'0", NO_COMMENT),
            t_alu_mode(this, "t_alu_mode", "3", "'0", NO_COMMENT),
            t_addsub_mode(this, "t_addsub_mode", "7", "'0", NO_COMMENT),
            t_shifter_mode(this, "t_shifter_mode", "4", "'0", NO_COMMENT)
        {
