    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) : ProcObject(parent, "comb"),
            ...
            vb_prog_npc(this, "vb_prog_npc", "CFG_CPU_ADDR_BITS"),
            vb_npc_incr(this, "vb_npc_incr", "CFG_CPU_ADDR_BITS"),
            vb_off(this, "vb_off", "RISCV_ARCH"),
            vb_sub64(this, "vb_sub64", "RISCV_ARCH"),
            vb_memop_memaddr(this, "vb_memop_memaddr", "CFG_CPU_ADDR_BITS"),
            vb_memop_memaddr_load(this, "vb_memop_memaddr_load", "CFG_CPU_ADDR_BITS"),
            vb_memop_memaddr_store(this, "vb_memop_memaddr_store", "CFG_CPU_ADDR_BITS"),
            ...
            v_eq(this, "v_eq", "1", "equal"),
            v_ge(this, "v_ge", "1", "greater/equal signed"),
            v_geu(this, "v_geu", "1", "greater/equal unsigned"),
            v_lt(this, "v_lt", "1", "less signed"),
            v_ltu(this, "v_ltu", "1", "less unsigned"),
            ...
            v_debug_misaligned(this, "v_debug_misaligned", "1", "from the debug interface"),
