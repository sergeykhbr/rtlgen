...
MemAccess::MemAccess(GenObject *parent, const char *name) :
    ...
    i_memop_addr(this, "i_memop_addr", "CFG_CPU_ADDR_BITS", "Memory access address"),
    ...
    o_mem_addr(this, "o_mem_addr", "CFG_CPU_ADDR_BITS", "Data path requested address"),
    ...
    i_mem_data_addr(this, "i_mem_data_addr", "CFG_CPU_ADDR_BITS", "Data path memory response address"),
    ...
    memop_wstrb(this, "memop_wstrb", "8"),
    memop_sign_ext(this, "memop_sign_ext", "1"),
    memop_size(this, "memop_size", "2"),
    memop_debug(this, "memop_debug", "1"),
    memop_res_pc(this, "memop_res_pc", "CFG_CPU_ADDR_BITS"),
    memop_res_instr(this, "memop_res_instr", "32"),
    memop_res_addr(this, "memop_res_addr", "6"),
    memop_res_wtag(this, "memop_res_wtag", "CFG_REG_TAG_WIDTH"),
    memop_res_data(this, "memop_res_data", "RISCV_ARCH"),
    memop_res_wena(this, "memop_res_wena", "1"),
    hold_rdata(this, "hold_rdata", "RISCV_ARCH"),
    pc(this, "pc", "CFG_CPU_ADDR_BITS"),
    valid(this, "valid", "1"),
    // process
    comb(this),
    // Signals
    QUEUE_WIDTH(this, "QUEUE_WIDTH", &CALCWIDTHx(13, &memop_debug,
                                                    &i_e_flushd,
                                                    &comb.vb_res_wtag,
                                                    &comb.vb_mem_wdata,
                                                    &comb.vb_mem_wstrb,
...
TEXT();
    ...
    SETVAL(queue_data_i, CCx(13, &comb.t_memop_debug,
                             &i_e_flushd,
                             &i_reg_wtag,
                             &comb.vb_memop_wdata,
                             &comb.vb_memop_wstrb,
...
TEXT();
    ...
    SPLx(queue_data_o, 13, &comb.v_mem_debug,
                           &comb.v_flushd,
                           &comb.vb_res_wtag,
                           &comb.vb_mem_wdata,
                           &comb.vb_mem_wstrb,
...
TEXT();
    ...
    CASE (CONST("1", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 8));
        ENDCASE();
    CASE (CONST("2", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 16));
        ENDCASE();
    CASE (CONST("3", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 24));
        ENDCASE();
    CASE (CONST("4", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 32));
        ENDCASE();
    CASE (CONST("5", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 40));
        ENDCASE();
    CASE (CONST("6", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 48));
        ENDCASE();
    CASE (CONST("7", 3));
        SETVAL(comb.vb_mem_resp_shifted, BITS(i_mem_data, 63, 56));
        ENDCASE();
    CASEDEF();
