...
TEXT();
    IF (EQ(state, State_Idle));
        ...
        SETVAL(comb.mux.rdata1, i_rdata1);
        SETVAL(comb.mux.rdata2, i_rdata2);
    ...
    ELSE();
        ...
        SETVAL(comb.mux.rdata1, rdata1);
        SETVAL(comb.mux.rdata2, rdata2);
...
TEXT();
    IF (NZ(BIT(comb.mux.isa_type, cfg->ISA_R_type)));
        SETVAL(comb.vb_rdata1, comb.mux.rdata1);
        SETVAL(comb.vb_rdata2, comb.mux.rdata2);
