...
TEXT();
    /*SETVAL(comb.v_f64, ORx(2,
        BIT(comb.vb_dec, "Instr_FADD_D"), BIT(comb.vb_dec, "Instr_FSUB_D")),
        BIT(comb.vb_dec, "Instr_FMUL_D"), BIT(comb.vb_dec, "Instr_FDIV_D"),
        BIT(comb.vb_dec, "Instr_FMIN_D"), BIT(comb.vb_dec, "Instr_FMAX_D"),
        BIT(comb.vb_dec, "Instr_FLE_D"), BIT(comb.vb_dec, "Instr_FLT_D"),
        BIT(comb.vb_dec, "Instr_FEQ_D"), BIT(comb.vb_dec, "Instr_FCVT_W_D"),
        BIT(comb.vb_dec, "Instr_FCVT_WU_D"), BIT(comb.vb_dec, "Instr_FCVT_L_D"),
        BIT(comb.vb_dec, "Instr_FCVT_LU_D"), BIT(comb.vb_dec, "Instr_FMOV_X_D"),
        BIT(comb.vb_dec, "Instr_FCVT_D_W"), BIT(comb.vb_dec, "Instr_FCVT_D_WU"),
        BIT(comb.vb_dec, "Instr_FCVT_D_L"), BIT(comb.vb_dec, "Instr_FCVT_D_LU"),
        BIT(comb.vb_dec, "Instr_FMOV_D_X"), BIT(comb.vb_dec, "Instr_FLD"),
