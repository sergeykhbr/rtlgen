...
DbgPort::DbgPort(GenObject *parent, const char *name) :
    ...
    // param
    idle(this, "4", "idle", "0"),
    csr_region(this, "4", "csr_region", "1"),
    reg_bank(this, "4", "reg_bank", "2"),
    reg_stktr_cnt(this, "4", "reg_stktr_cnt", "3"),
    reg_stktr_buf_adr(this, "4", "reg_stktr_buf_adr", "4"),
    reg_stktr_buf_dat(this, "4", "reg_stktr_buf_dat", "5"),
    exec_progbuf_start(this, "4", "exec_progbuf_start", "6"),
    exec_progbuf_next(this, "4", "exec_progbuf_next", "7"),
    exec_progbuf_waitmemop(this, "4", "exec_progbuf_waitmemop", "8"),
    abstract_mem_request(this, "4", "abstract_mem_request", "9"),
    abstract_mem_response(this, "4", "abstract_mem_response", "10"),
