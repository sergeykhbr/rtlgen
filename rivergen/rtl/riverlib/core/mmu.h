    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) : ProcObject(parent, "comb"),
            ...
            vb_core_resp_addr(this, "vb_core_resp_addr", "RISCV_ARCH"),
            ...
            vb_last_pa_req(this, "vb_last_pa_req", "RISCV_ARCH"),
            v_mem_req_valid(this, "v_mem_req_valid", "1"),
            vb_mem_req_addr(this, "vb_mem_req_addr", "RISCV_ARCH"),
            vb_mem_req_type(this, "vb_mem_req_type", "MemopType_Total"),
            vb_mem_req_wdata(this, "vb_mem_req_wdata", "64"),
            vb_mem_req_wstrb(this, "vb_mem_req_wstrb", "8"),
            vb_mem_req_size(this, "vb_mem_req_size", "2"),
            v_mem_resp_ready(this, "v_mem_resp_ready", "1"),
            v_tlb_wena(this, "v_tlb_wena", "1"),
            vb_tlb_adr(this, "vb_tlb_adr", "CFG_MMU_TLB_AWIDTH"),
            vb_pte_start_va(this, "vb_pte_start_va", "SUB(RISCV_ARCH,12)"),
            vb_resp_ppn(this, "vb_resp_ppn", "SUB(RISCV_ARCH,12)"),
            ...
            vb_tlb_pa0(this, "vb_tlb_pa0", "RISCV_ARCH", "4 KB page phys address"),
            vb_tlb_pa1(this, "vb_tlb_pa1", "RISCV_ARCH", "8 MB page phys address"),
            vb_tlb_pa2(this, "vb_tlb_pa2", "RISCV_ARCH", "16 GB page phys address"),
            vb_tlb_pa3(this, "vb_tlb_pa3", "RISCV_ARCH", "32 TB page phys address"),
            vb_tlb_pa_hit(this, "vb_tlb_pa_hit", "RISCV_ARCH"),
