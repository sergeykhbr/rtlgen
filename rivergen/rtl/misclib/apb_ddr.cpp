...
apb_ddr::apb_ddr(GenObject *parent, const char *name) :
    ...
    // registers
    pll_locked(this, "pll_locked", "1"),
    init_calib_done(this, "init_calib_done", "1"),
    device_temp(this, "device_temp", "12"),
    sr_active(this, "sr_active", "1"),
    ref_ack(this, "ref_ack", "1"),
    zq_ack(this, "zq_ack", "1"),
    ...
    pslv0(this, "pslv0")
{
    ...
    pslv0.did.setObjValue(&glob_types_amba_->OPTIMITECH_DDRCTRL);
