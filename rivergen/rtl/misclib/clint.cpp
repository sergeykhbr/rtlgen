...
clint::clint(GenObject *parent, const char *name) :
    ModuleObject(parent, "clint", name),
    cpu_total(this, "cpu_total", "4"),
    ...
    xslv0(this, "xslv0")
{
    ...
    xslv0.did.setObjValue(&glob_types_amba_->OPTIMITECH_CLINT);
