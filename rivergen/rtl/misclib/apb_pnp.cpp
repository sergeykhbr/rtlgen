...
apb_pnp::apb_pnp(GenObject *parent, const char *name) :
    ...
    idt_l(this, "idt_l", "32"),
    idt_m(this, "idt_m", "32"),
    malloc_addr_l(this, "malloc_addr_l", "32"),
    malloc_addr_m(this, "malloc_addr_m", "32"),
    malloc_size_l(this, "malloc_size_l", "32"),
    malloc_size_m(this, "malloc_size_m", "32"),
    fwdbg1(this, "fwdbg1", "32"),
    fwdbg2(this, "fwdbg2", "32"),
    fwdbg3(this, "fwdbg3", "32"),
    fwdbg4(this, "fwdbg4", "32"),
    fwdbg5(this, "fwdbg5", "32"),
    fwdbg6(this, "fwdbg6", "32"),
    irq(this, "irq", "1"),
