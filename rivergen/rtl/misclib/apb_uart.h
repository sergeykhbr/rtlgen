    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) :
            ...
            vb_tx_fifo_rdata(this, "vb_tx_fifo_rdata", "8", "'0", NO_COMMENT),
            v_tx_fifo_we(this, "v_tx_fifo_we", "1"),
            vb_rx_wr_cnt_next(this, "vb_rx_wr_cnt_next", "log2_fifosz", "'0", NO_COMMENT),
            v_rx_fifo_full(this, "v_rx_fifo_full", "1"),
            v_rx_fifo_empty(this, "v_rx_fifo_empty", "1"),
            vb_rx_fifo_rdata(this, "vb_rx_fifo_rdata", "8", "'0", NO_COMMENT),
