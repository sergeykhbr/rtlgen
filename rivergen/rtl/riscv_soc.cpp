...
riscv_soc::riscv_soc(GenObject *parent, const char *name, const char *comment) :
    ...
    i_pcie_usr_clk(this, "i_pcie_usr_clk", "1", "Clock generated by end-point IP (user clock 200 MHz)"),
    i_pcie_usr_rst(this, "i_pcie_usr_rst", "1", "Active HIGH end-point generated reset"),
    o_pcie_pmapinfo(this, "o_pcie_pmapinfo", "PCIE APB controller mapping information"),
    i_pcie_pdevcfg(this, "i_pcie_pdevcfg", "PCIE APB controller device descriptor"),
    o_pcie_apbi(this, "o_pcie_apbi", "APB: PCIE configuration interface"),
    i_pcie_apbo(this, "i_pcie_apbo", "APB: PCIE configuration interface"),
...
TEXT();
    NEW(pcidma0, pcidma0.getName().c_str());
        CONNECT(pcidma0, 0, pcidma0.i_sys_nrst, i_sys_nrst);
        CONNECT(pcidma0, 0, pcidma0.i_sys_clk, i_sys_clk);
        CONNECT(pcidma0, 0, pcidma0.i_pcie_usr_rst, i_pcie_usr_rst);
        CONNECT(pcidma0, 0, pcidma0.i_pcie_usr_clk, i_pcie_usr_clk);
...
#if GENCFG_PCIE_ENABLE
    TEXT();
    TEXT("PCIE controller:");
    SETVAL(o_pcie_pmapinfo, ARRITEM(bus1_mapinfo, glob_bus1_cfg_->CFG_BUS1_PSLV_PCIE, bus1_mapinfo));
    SETARRITEM(dev_pnp, glob_pnp_cfg_->SOC_PNP_PCIE_APB, dev_pnp, i_pcie_pdevcfg);
    SETVAL(o_pcie_apbi, ARRITEM(apbi, glob_bus1_cfg_->CFG_BUS1_PSLV_PCIE, apbi));
    SETARRITEM(apbo, glob_bus1_cfg_->CFG_BUS1_PSLV_PCIE, apbo, i_pcie_apbo);
#endif
}
