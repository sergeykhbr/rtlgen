...
riscv_soc::riscv_soc(GenObject *parent, const char *name, const char *comment) :
    ...
    i_pcie_phy_nrst(this, "i_pcie_phy_nrst", "1", "PCIE user reset: active LOW until link up"),
...
TEXT();
    ...
    NEW(pcidma0, pcidma0.getName().c_str());
        ...
        CONNECT(pcidma0, 0, pcidma0.i_pcie_phy_nrst, i_pcie_phy_nrst);
        CONNECT(pcidma0, 0, pcidma0.i_pcie_phy_clk, i_pcie_phy_clk);
