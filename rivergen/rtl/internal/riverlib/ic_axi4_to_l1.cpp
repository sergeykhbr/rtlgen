...
ic_axi4_to_l1::ic_axi4_to_l1(GenObject *parent, const char *name, const char *comment) :
    ...
    o_l1o(this, "o_l1o"),
    // params:
    Idle(this, "Idle", "4", "0", "axi ar_ready=1,aw_ready=1"),
    ReadLineRequest(this, "ReadLineRequest", "4", "1", "l1 ar_valid=1"),
    WaitReadLineResponse(this, "WaitReadLineResponse", "4", "2", "l1 r_ready=1"),
    WriteDataAccept(this, "WriteDataAccept", "4", "3", "axi w_ready=1"),
    WriteLineRequest(this, "WriteLineRequest", "4", "4", "l1 w_valid=1"),
    WaitWriteConfirmResponse(this, "WaitWriteConfirmResponse", "4", "5", "l1 b_ready"),
    WaitWriteAccept(this, "WaitWriteAccept", "4", "6", "axi b_valid"),
    WaitReadAccept(this, "WaitReadAccept", "4", "7", "axi r_valid"),
    CheckBurst(this, "CheckBurst", "4", "8", NO_COMMENT),
    // registers
    ...
    line_data(this, "line_data", "L1CACHE_LINE_BITS", "'0", NO_COMMENT),
    line_wstrb(this, "line_wstrb", "L1CACHE_BYTES_PER_LINE", "'0", NO_COMMENT),
    resp_data(this, "resp_data", "64", "'0", NO_COMMENT),
    comb(this)
{
