...
InstrExecute::InstrExecute(GenObject *parent, const char *name, const char *comment) :
    ...
    _state0_(this),
    State_Idle(this, "State_Idle", "4", "0", NO_COMMENT),
    State_WaitMemAcces(this, "State_WaitMemAcces", "4", "1", NO_COMMENT),
    State_WaitMulti(this, "State_WaitMulti", "4", "2", NO_COMMENT),
    State_Amo(this, "State_Amo", "4", "5", NO_COMMENT),
    State_Csr(this, "State_Csr", "4", "6", NO_COMMENT),
    State_Halted(this, "State_Halted", "4", "7", NO_COMMENT),
    State_DebugMemRequest(this, "State_DebugMemRequest", "4", "8", NO_COMMENT),
    State_DebugMemError(this, "State_DebugMemError", "4", "9", NO_COMMENT),
    State_Wfi(this, "State_Wfi", "4", "0xf", NO_COMMENT),
    _csrstate0_(this),
    CsrState_Idle(this, "CsrState_Idle", "2", "0", NO_COMMENT),
    CsrState_Req(this, "CsrState_Req", "2", "1", NO_COMMENT),
    CsrState_Resp(this, "CsrState_Resp", "2", "2", NO_COMMENT),
    _amostate0_(this),
    AmoState_WaitMemAccess(this, "AmoState_WaitMemAccess", "2", "0", NO_COMMENT),
    AmoState_Read(this, "AmoState_Read", "2", "1", NO_COMMENT),
    AmoState_Modify(this, "AmoState_Modify", "2", "2", NO_COMMENT),
    AmoState_Write(this, "AmoState_Write", "2", "3", NO_COMMENT),
    // structures
    select_type_def_(this, "select_type", NO_COMMENT),
    irq2idx(this),
    input_mux_type_def_(this, "input_mux_type", NO_COMMENT),
    // signals
    wb_select(this, "wb_select", "Res_Total", NO_COMMENT),
    ...
    dnpc(this, "dnpc", "RISCV_ARCH", "'0", NO_COMMENT),
    radr1(this, "radr1", "6", "'0", NO_COMMENT),
    radr2(this, "radr2", "6", "'0", NO_COMMENT),
    waddr(this, "waddr", "6", "'0", NO_COMMENT),
    rdata1(this, "rdata1", "RISCV_ARCH", "'0", NO_COMMENT),
    rdata2(this, "rdata2", "RISCV_ARCH", "'0", NO_COMMENT),
    rdata1_amo(this, "rdata1_amo", "RISCV_ARCH", "'0", NO_COMMENT),
    rdata2_amo(this, "rdata2_amo", "RISCV_ARCH", "'0", NO_COMMENT),
    ...
    reg_waddr(this, "reg_waddr", "6", "'0", NO_COMMENT),
    reg_wtag(this, "reg_wtag", "CFG_REG_TAG_WIDTH", "'0", NO_COMMENT),
    csr_req_rmw(this, "csr_req_rmw", "1", "0", "csr read-modify-write request"),
    csr_req_type(this, "csr_req_type", "CsrReq_TotalBits", "'0", NO_COMMENT),
    csr_req_addr(this, "csr_req_addr", "12", "'0", NO_COMMENT),
    csr_req_data(this, "csr_req_data", "RISCV_ARCH", "'0", NO_COMMENT),
    ...
    memop_memaddr(this, "memop_memaddr", "RISCV_ARCH", "'0", NO_COMMENT),
    memop_wdata(this, "memop_wdata", "RISCV_ARCH", "'0", NO_COMMENT),
    ...
    mem_ex_addr(this, "mem_ex_addr", "RISCV_ARCH", "'0", NO_COMMENT),
    res_npc(this, "res_npc", "RISCV_ARCH", "'0", NO_COMMENT),
    res_ra(this, "res_ra", "RISCV_ARCH", "'0", NO_COMMENT),
    res_csr(this, "res_csr", "RISCV_ARCH", "'0", NO_COMMENT),
    select(this, "select", "Res_Total", "'0", NO_COMMENT),
    valid(this, "valid", "1"),
    call(this, "call", "1"),
    ret(this, "ret", "1"),
    jmp(this, "jmp", "1"),
    ...
    fpu0(this, "fpu0")
{
    ...
    NEW(alu0, alu0.getName().c_str());
        ...
        CONNECT(alu0, 0, alu0.o_res, ARRITEM_B(wb_select, Res_Alu, wb_select.res));
    ENDNEW();
...
TEXT();
    NEW(addsub0, addsub0.getName().c_str());
        ...
        CONNECT(addsub0, 0, addsub0.o_res, ARRITEM_B(wb_select, Res_AddSub, wb_select.res));
    ENDNEW();
...
TEXT();
    NEW(mul0, mul0.getName().c_str());
        ...
        CONNECT(mul0, 0, mul0.i_ena, ARRITEM_B(wb_select, Res_IMul, wb_select.ena));
        ...
        CONNECT(mul0, 0, mul0.o_res, ARRITEM_B(wb_select, Res_IMul, wb_select.res));
        CONNECT(mul0, 0, mul0.o_valid, ARRITEM_B(wb_select, Res_IMul, wb_select.valid));
    ENDNEW();
...
TEXT();
    NEW(div0, div0.getName().c_str());
        ...
        CONNECT(div0, 0, div0.i_ena, ARRITEM_B(wb_select, Res_IDiv, wb_select.ena));
        ...
        CONNECT(div0, 0, div0.o_res, ARRITEM_B(wb_select, Res_IDiv, wb_select.res));
        CONNECT(div0, 0, div0.o_valid, ARRITEM_B(wb_select, Res_IDiv, wb_select.valid));
    ENDNEW();
...
TEXT();
    NEW(sh0, sh0.getName().c_str());
        ...
        CONNECT(sh0, 0, sh0.o_res, ARRITEM_B(wb_select, Res_Shifter, wb_select.res));
    ENDNEW();
    ...
    GENERATE("fpu");
        IFGEN (fpu_ena, new StringConst("fpu_en"));
            NEW(fpu0, fpu0.getName().c_str());
                ...
                CONNECT(fpu0, 0, fpu0.i_ena, ARRITEM_B(wb_select, Res_FPU, wb_select.ena));
                CONNECT(fpu0, 0, fpu0.i_ivec, wb_fpu_vec);
                CONNECT(fpu0, 0, fpu0.i_a, wb_rdata1);
                CONNECT(fpu0, 0, fpu0.i_b, wb_rdata2);
                CONNECT(fpu0, 0, fpu0.o_res, ARRITEM_B(wb_select, Res_FPU, wb_select.res));
                ...
                CONNECT(fpu0, 0, fpu0.o_valid, ARRITEM_B(wb_select, Res_FPU, wb_select.valid));
            ENDNEW();
        ELSEGEN(new StringConst("fpu"));
            ASSIGNZERO(ARRITEM_B(wb_select, Res_FPU, wb_select.res));
            ASSIGNZERO(ARRITEM_B(wb_select, Res_FPU, wb_select.valid));
...
void InstrExecute::proc_comb() {
    ...
    GenObject &i1 = FOR ("i", CONST("0"), Res_Total, "++");
        SETARRITEM(wb_select, i1, wb_select.ena, CONST("0"));
    ENDFOR();
