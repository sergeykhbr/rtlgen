    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) : ProcObject(parent, "comb"),
            ...
            vb_jal_off(this, "vb_jal_off", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_jal_addr(this, "vb_jal_addr", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_branch_off(this, "vb_branch_off", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_branch_addr(this, "vb_branch_addr", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_c_j_off(this, "vb_c_j_off", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_c_j_addr(this, "vb_c_j_addr", "RISCV_ARCH", "'0", NO_COMMENT) {
