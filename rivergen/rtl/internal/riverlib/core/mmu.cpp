...
Mmu::Mmu(GenObject *parent, const char *name, const char *comment) :
    ...
    req_r(this, "req_r", "1"),
    req_w(this, "req_w", "1"),
    req_pa(this, "req_pa", "RISCV_ARCH", "'0", NO_COMMENT),
    ...
    req_size(this, "req_size", "2", "'0", NO_COMMENT),
    ...
    last_page_size(this, "last_page_size", "2", "'0", NO_COMMENT),
    resp_addr(this, "resp_addr", "RISCV_ARCH", "'0", NO_COMMENT),
    ...
    tlb_level(this, "tlb_level", "4", "'0", NO_COMMENT),
    tlb_page_size(this, "tlb_page_size", "2", "'0", NO_COMMENT),
    tlb_wdata(this, "tlb_wdata", "CFG_MMU_PTE_DWIDTH", "'0", NO_COMMENT),
    tlb_flush_cnt(this, "tlb_flush_cnt", "CFG_MMU_TLB_AWIDTH", "'1", NO_COMMENT),
    tlb_flush_adr(this, "tlb_flush_adr", "CFG_MMU_TLB_AWIDTH", "'0", NO_COMMENT),
    // process
    comb(this),
    // sub-modules
    tlb(this, "tlb")
