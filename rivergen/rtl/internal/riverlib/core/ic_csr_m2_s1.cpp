...
ic_csr_m2_s1::ic_csr_m2_s1(GenObject *parent, const char *name, const char *comment) :
    ModuleObject(parent, "ic_csr_m2_s1", name, comment),
    i_clk(this, "i_clk", "1", "CPU clock"),
    i_nrst(this, "i_nrst", "1", "Reset: active LOW"),
    _Master0_(this, "master[0]:"),
    i_m0_req_valid(this, "i_m0_req_valid", "1"),
    o_m0_req_ready(this, "o_m0_req_ready", "1"),
    ...
    o_m0_resp_valid(this, "o_m0_resp_valid", "1"),
    i_m0_resp_ready(this, "i_m0_resp_ready", "1"),
    o_m0_resp_data(this, "o_m0_resp_data", "RISCV_ARCH"),
    o_m0_resp_exception(this, "o_m0_resp_exception", "1"),
    _Master1_(this, "master[1]"),
    i_m1_req_valid(this, "i_m1_req_valid", "1"),
    o_m1_req_ready(this, "o_m1_req_ready", "1"),
    ...
    o_m1_resp_valid(this, "o_m1_resp_valid", "1"),
    i_m1_resp_ready(this, "i_m1_resp_ready", "1"),
    o_m1_resp_data(this, "o_m1_resp_data", "RISCV_ARCH"),
    o_m1_resp_exception(this, "o_m1_resp_exception", "1"),
    _Slave0_(this, "slave[0]"),
    o_s0_req_valid(this, "o_s0_req_valid", "1"),
    i_s0_req_ready(this, "i_s0_req_ready", "1"),
    ...
    i_s0_resp_valid(this, "i_s0_resp_valid", "1"),
    o_s0_resp_ready(this, "o_s0_resp_ready", "1"),
