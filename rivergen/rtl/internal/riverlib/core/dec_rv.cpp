...
DecoderRv::DecoderRv(GenObject *parent, const char *name, const char *depth) :
    ...
    // param
    OPCODE_LB(this, "OPCODE_LB", "5", "0x00", "00000: LB, LH, LW, LD, LBU, LHU, LWU"),
    OPCODE_FPU_LD(this, "OPCODE_FPU_LD", "5", "0x01", "00001: FLD"),
    OPCODE_FENCE(this, "OPCODE_FENCE", "5", "0x03", "00011: FENCE, FENCE_I"),
    OPCODE_ADDI(this, "OPCODE_ADDI", "5", "0x04", "00100: ADDI, ANDI, ORI, SLLI, SLTI, SLTIU, SRAI, SRLI, XORI"),
    OPCODE_AUIPC(this, "OPCODE_AUIPC", "5", "0x05", "00101: AUIPC"),
    OPCODE_ADDIW(this, "OPCODE_ADDIW", "5", "0x06", "00110: ADDIW, SLLIW, SRAIW, SRLIW"),
    OPCODE_SB(this, "OPCODE_SB", "5", "0x08", "01000: SB, SH, SW, SD"),
    OPCODE_FPU_SD(this, "OPCODE_FPU_SD", "5", "0x09", "01001: FSD"),
    OPCODE_AMO(this, "OPCODE_AMO", "5", "0x0B", "01011: Atomic opcode (AMO)"),
    OPCODE_ADD(this, "OPCODE_ADD", "5", "0x0C", "01100: ADD, AND, OR, SLT, SLTU, SLL, SRA, SRL, SUB, XOR, DIV, DIVU, MUL, REM, REMU"),
    OPCODE_LUI(this, "OPCODE_LUI", "5", "0x0D", "01101: LUI"),
    OPCODE_ADDW(this, "OPCODE_ADDW", "5", "0x0E", "01110: ADDW, SLLW, SRAW, SRLW, SUBW, DIVW, DIVUW, MULW, REMW, REMUW"),
    OPCODE_FPU_OP(this, "OPCODE_FPU_OP", "5", "0x14", "10100: FPU operation"),
    OPCODE_BEQ(this, "OPCODE_BEQ", "5", "0x18", "11000: BEQ, BNE, BLT, BGE, BLTU, BGEU"),
    OPCODE_JALR(this, "OPCODE_JALR", "5", "0x19", "11001: JALR"),
    OPCODE_JAL(this, "OPCODE_JAL", "5", "0x1B", "11011: JAL"),
    OPCODE_CSRR(this, "OPCODE_CSRR", "5", "0x1C", "11100: CSRRC, CSRRCI, CSRRS, CSRRSI, CSRRW, CSRRWI, URET, SRET, HRET, MRET"),
    // signals
    // registers
...
TEXT();
    ...
    CASE (OPCODE_CSRR);
        ...
        CASE (CONST("0"));
            ...
            ELSIF(AND2(EQ(BITS(comb.vb_instr, 31, 25), CONST("0x09", 7)), EZ(comb.vb_waddr)));
                SETBITONE(comb.vb_dec, "Instr_SFENCE_VMA");
            ELSE();
                SETONE(comb.v_error);
            ENDIF();
            ENDCASE();
