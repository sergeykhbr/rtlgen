...
DoubleMul::DoubleMul(GenObject *parent, const char *name, const char *comment) :
    ModuleObject(parent, "DoubleMul", name, comment),
    ...
    expAlign(this, "expAlign", "12", "'0", NO_COMMENT),
