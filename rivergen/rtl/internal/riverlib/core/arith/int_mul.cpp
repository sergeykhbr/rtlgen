...
IntMul::IntMul(GenObject *parent, const char *name, const char *comment) :
    ...
    // registers
    busy(this, "busy", "1"),
    ena(this, "ena", "4", "'0", NO_COMMENT),
    a1(this, "a1", "RISCV_ARCH", "'0", NO_COMMENT),
    a2(this, "a2", "RISCV_ARCH", "'0", NO_COMMENT),
    unsign(this, "unsign", "1"),
    high(this, "high", "1"),
    rv32(this, "rv32", "1"),
    zero(this, "zero", "1"),
    inv(this, "inv", "1"),
    result(this, "result", "128", "'0", NO_COMMENT),
    a1_dbg(this, "a1_dbg", "RISCV_ARCH", "'0", NO_COMMENT),
    a2_dbg(this, "a2_dbg", "RISCV_ARCH", "'0", NO_COMMENT),
    reference_mul(this, "reference_mul", "RISCV_ARCH", "0", "Used for run-time comparision"),
    lvl1(this, &i_clk, &i_nrst, "lvl1", "69", "16"),
    lvl3(this, &i_clk, &i_nrst, "lvl3", "83", "4"),
    // process
    comb(this)
{
