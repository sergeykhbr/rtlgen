...
IntDiv::IntDiv(GenObject *parent, const char *name, const char *comment) :
    ModuleObject(parent, "IntDiv", name, comment),
    ...
    busy(this, "busy", "1"),
    ena(this, "ena", "10", "'0", NO_COMMENT),
    divident_i(this, "divident_i", "64", "'0", NO_COMMENT),
    divisor_i(this, "divisor_i", "120", "'0", NO_COMMENT),
    bits_i(this, "bits_i", "64", "'0", NO_COMMENT),
    result(this, "result", "RISCV_ARCH", "'0", NO_COMMENT),
    reference_div(this, "reference_div", "RISCV_ARCH", "'0", NO_COMMENT),
    a1_dbg(this, "a1_dbg", "64", "'0", "Store this value for output in a case of error"),
    a2_dbg(this, "a2_dbg", "64", "'0", NO_COMMENT),
    // process
    comb(this),
    stage0(this, "stage0"),
    stage1(this, "stage1")
