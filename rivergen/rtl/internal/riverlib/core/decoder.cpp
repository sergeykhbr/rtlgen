    ...
    rvc(this, "rvc", "DEC_NUM", NO_COMMENT)
{
    ...
    GenObject *i = &FORGEN ("i", CONST("0"), CONST("DEC_NUM"), "++", new StringConst("rvx"));
        NEW(rv, rv.getName().c_str(), i);
            ...
            CONNECT(rv, i, rv.i_f_pc, ARRITEM_B(wb_f_pc, *i, wb_f_pc));
            CONNECT(rv, i, rv.i_f_instr, ARRITEM_B(wb_f_instr, *i, wb_f_instr));
            CONNECT(rv, i, rv.i_instr_load_fault, i_instr_load_fault);
            CONNECT(rv, i, rv.i_instr_page_fault_x, i_instr_page_fault_x);
            CONNECT(rv, i, rv.o_radr1, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.radr1));
            CONNECT(rv, i, rv.o_radr2, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.radr2));
            CONNECT(rv, i, rv.o_waddr, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.waddr));
            CONNECT(rv, i, rv.o_csr_addr, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.csr_addr));
            CONNECT(rv, i, rv.o_imm, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.imm));
            CONNECT(rv, i, rv.o_pc, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.pc));
            CONNECT(rv, i, rv.o_instr, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.instr));
            CONNECT(rv, i, rv.o_memop_store, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.memop_store));
            CONNECT(rv, i, rv.o_memop_load, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.memop_load));
            CONNECT(rv, i, rv.o_memop_sign_ext, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.memop_sign_ext));
            CONNECT(rv, i, rv.o_memop_size, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.memop_size));
            CONNECT(rv, i, rv.o_rv32, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.rv32));
            CONNECT(rv, i, rv.o_compressed, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.compressed));
            CONNECT(rv, i, rv.o_amo, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.amo));
            CONNECT(rv, i, rv.o_f64, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.f64));
            CONNECT(rv, i, rv.o_unsigned_op, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.unsigned_op));
            CONNECT(rv, i, rv.o_isa_type, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.isa_type));
            CONNECT(rv, i, rv.o_instr_vec, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.instr_vec));
            CONNECT(rv, i, rv.o_exception, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.instr_unimplemented));
            CONNECT(rv, i, rv.o_instr_load_fault, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.instr_load_fault));
            CONNECT(rv, i, rv.o_instr_page_fault_x, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.instr_page_fault_x));
            CONNECT(rv, i, rv.o_progbuf_ena, ARRITEM_B(wd, MUL2(CONST("2"), *i), wd.progbuf_ena));
        ENDNEW();
...
TEXT();
    i = &FORGEN ("i", CONST("0"), CONST("DEC_NUM"), "++", new StringConst("rvcx"));
        NEW(rvc, rvc.getName().c_str(), i);
            ...
            CONNECT(rvc, i, rvc.i_f_pc, ARRITEM_B(wb_f_pc, *i, wb_f_pc));
            CONNECT(rvc, i, rvc.i_f_instr, ARRITEM_B(wb_f_instr, *i, wb_f_instr));
            CONNECT(rvc, i, rvc.i_instr_load_fault, i_instr_load_fault);
            CONNECT(rvc, i, rvc.i_instr_page_fault_x, i_instr_page_fault_x);
            CONNECT(rvc, i, rvc.o_radr1, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.radr1));
            CONNECT(rvc, i, rvc.o_radr2, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.radr2));
            CONNECT(rvc, i, rvc.o_waddr, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.waddr));
            CONNECT(rvc, i, rvc.o_csr_addr, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.csr_addr));
            CONNECT(rvc, i, rvc.o_imm, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.imm));
            CONNECT(rvc, i, rvc.o_pc, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.pc));
            CONNECT(rvc, i, rvc.o_instr, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.instr));
            CONNECT(rvc, i, rvc.o_memop_store, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.memop_store));
            CONNECT(rvc, i, rvc.o_memop_load, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.memop_load));
            CONNECT(rvc, i, rvc.o_memop_sign_ext, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.memop_sign_ext));
            CONNECT(rvc, i, rvc.o_memop_size, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.memop_size));
            CONNECT(rvc, i, rvc.o_rv32, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.rv32));
            CONNECT(rvc, i, rvc.o_compressed, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.compressed));
            CONNECT(rvc, i, rvc.o_amo, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.amo));
            CONNECT(rvc, i, rvc.o_f64, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.f64));
            CONNECT(rvc, i, rvc.o_unsigned_op, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.unsigned_op));
            CONNECT(rvc, i, rvc.o_isa_type, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.isa_type));
            CONNECT(rvc, i, rvc.o_instr_vec, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.instr_vec));
            CONNECT(rvc, i, rvc.o_exception, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.instr_unimplemented));
            CONNECT(rvc, i, rvc.o_instr_load_fault, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.instr_load_fault));
            CONNECT(rvc, i, rvc.o_instr_page_fault_x, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.instr_page_fault_x));
            CONNECT(rvc, i, rvc.o_progbuf_ena, ARRITEM_B(wd, INC(MUL2(CONST("2"), *i)), wd.progbuf_ena));
        ENDNEW();
