...
Processor::Processor(GenObject *parent, const char *name, const char *comment) :
    ...
    o_req_ctrl_addr(this, "o_req_ctrl_addr", "RISCV_ARCH", "Requesting address to ICache"),
    ...
    o_req_data_addr(this, "o_req_data_addr", "RISCV_ARCH", "Requesting address to DCache"),
    ...
    o_flushi_addr(this, "o_flushi_addr", "RISCV_ARCH", "Address of instruction to remove from ICache"),
    o_flushd_valid(this, "o_flushd_valid", "1", "Remove address from D$ is valid"),
    o_flushd_addr(this, "o_flushd_addr", "RISCV_ARCH", "Address of instruction to remove from D$"),
    i_flushd_end(this, "i_flushd_end", "1"),
    // struct declration
    FetchTypeDef_(this, "FetchType", NO_COMMENT),
    MmuTypeDef_(this, "MmuType", NO_COMMENT),
    InstructionDecodeTypeDef_(this, "InstructionDecodeType", NO_COMMENT),
    ExecuteTypeDef_(this, "ExecuteType", NO_COMMENT),
    MemoryTypeDef_(this, "MemoryType", NO_COMMENT),
    WriteBackTypeDef_(this, "WriteBackType", NO_COMMENT),
    IntRegsTypeDef_(this, "IntRegsType", NO_COMMENT),
    CsrTypeDef_(this, "CsrType", NO_COMMENT),
    DebugTypeDef_(this, "DebugType", NO_COMMENT),
    BranchPredictorTypeDef_(this, "BranchPredictorType", NO_COMMENT),
    PipelineTypeDef_(this, "PipelineType", NO_COMMENT),
    // Internal signals
    w(this, "w", "5-stages CPU pipeline"),
    immu(this, "immu", NO_COMMENT),
    dmmu(this, "dmmu", NO_COMMENT),
    ireg(this, "ireg", NO_COMMENT),
    csr(this, "csr", NO_COMMENT),
    dbg(this, "dbg", NO_COMMENT),
    bp(this, "bp", NO_COMMENT),
    _CsrBridge0_(this),
