    ...
    class CombProcess : public CombinationalProcess {
     public:
        CombProcess(GenObject *parent) :
            ...
            vb_mem_type(this, "vb_mem_type", "MemopType_Total", "'0", NO_COMMENT),
            v_mem_sign_ext(this, "v_mem_sign_ext", "1"),
            vb_mem_sz(this, "vb_mem_sz", "2", "'0", NO_COMMENT),
            vb_mem_addr(this, "vb_mem_addr", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_mem_rdata(this, "vb_mem_rdata", "64", "'0", NO_COMMENT),
            ...
            vb_res_wtag(this, "vb_res_wtag", "CFG_REG_TAG_WIDTH", "'0", NO_COMMENT),
            vb_mem_wdata(this, "vb_mem_wdata", "64", "'0", NO_COMMENT),
            vb_mem_wstrb(this, "vb_mem_wstrb", "8", "'0", NO_COMMENT),
            vb_mem_resp_shifted(this, "vb_mem_resp_shifted", "64", "'0", NO_COMMENT),
            vb_mem_data_unsigned(this, "vb_mem_data_unsigned", "64", "'0", NO_COMMENT),
            vb_mem_data_signed(this, "vb_mem_data_signed", "64", "'0", NO_COMMENT),
            vb_res_data(this, "vb_res_data", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_res_addr(this, "vb_res_addr", "6", "'0", NO_COMMENT),
            vb_e_pc(this, "vb_e_pc", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_e_instr(this, "vb_e_instr", "32", "'0", NO_COMMENT),
            v_memop_ready(this, "v_memop_ready", "1"),
            v_o_wena(this, "v_o_wena", "1"),
            vb_o_waddr(this, "vb_o_waddr", "6", "'0", NO_COMMENT),
            vb_o_wdata(this, "vb_o_wdata", "RISCV_ARCH", "'0", NO_COMMENT),
            vb_o_wtag(this, "vb_o_wtag", "CFG_REG_TAG_WIDTH", "'0", NO_COMMENT),
