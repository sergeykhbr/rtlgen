...
L2CacheLru::L2CacheLru(GenObject *parent, const char *name, const char *comment) :
    ...
    ways(this, "ways", "POW2(1,CFG_L2_LOG2_NWAYS)"),
    _1_(this),
    ...
    _3_(this),
    LINE_BYTES_MASK(this, "LINE_BYTES_MASK", "CFG_CPU_ADDR_BITS", "SUB(POW2(1,CFG_L2_LOG2_BYTES_PER_LINE),1)", NO_COMMENT),
    FLUSH_ALL_VALUE(this, "FLUSH_ALL_VALUE", "32", "SUB(POW2(1,ADD(CFG_L2_LOG2_LINES_PER_WAY,CFG_L2_LOG2_NWAYS)),1)", "Actual bitwidth is (ibits + waybits) but to avoid sc template generation use 32-bits"),
    // signals
    ...
    mem_wstrb(this, "mem_wstrb", "L2CACHE_BYTES_PER_LINE", "'0", NO_COMMENT),
    ...
    cache_line_i(this, "cache_line_i", "L2CACHE_LINE_BITS", "'0", NO_COMMENT),
    cache_line_o(this, "cache_line_o", "L2CACHE_LINE_BITS", "'0", NO_COMMENT),
    // process
    comb(this),
    mem0(this, "mem0")
{
