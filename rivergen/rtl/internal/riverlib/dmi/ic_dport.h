    ...
    class CombProcess : public CombinationalProcess {
     public:
        CombProcess(GenObject* parent)
            ...
            vb_req_valid_mask(this, "vb_req_valid_mask", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_haltreq(this, "vb_haltreq", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_resumereq(this, "vb_resumereq", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_resethaltreq(this, "vb_resethaltreq", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_hartreset(this, "vb_hartreset", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_req_valid(this, "vb_req_valid", "CFG_CPU_MAX", "'0", NO_COMMENT),
            vb_req_ready(this, "vb_req_ready", "CFG_CPU_MAX", "'0", NO_COMMENT),
