...
dmidebug::dmidebug(GenObject *parent, const char *name, const char *comment) :
    ...
    // param
    CMDERR_NONE(this, "CMDERR_NONE", "3", "0", NO_COMMENT),
    CMDERR_BUSY(this, "CMDERR_BUSY", "3", "1", NO_COMMENT),
    CMDERR_NOTSUPPROTED(this, "CMDERR_NOTSUPPROTED", "3", "2", NO_COMMENT),
    CMDERR_EXCEPTION(this, "CMDERR_EXCEPTION", "3", "3", NO_COMMENT),
    CMDERR_WRONGSTATE(this, "CMDERR_WRONGSTATE", "3", "4", NO_COMMENT),
    CMDERR_BUSERROR(this, "CMDERR_BUSERROR", "3", "5", NO_COMMENT),
    CMDERR_OTHERS(this, "CMDERR_OTHERS", "3", "7", NO_COMMENT),
    ...
    DM_STATE_IDLE(this, "DM_STATE_IDLE", "1", "0", NO_COMMENT),
    DM_STATE_ACCESS(this, "DM_STATE_ACCESS", "1", "1", NO_COMMENT),
    _cmdstate0_(this, "cmdstate:"),
    CMD_STATE_IDLE(this, "CMD_STATE_IDLE", "3", "0", NO_COMMENT),
    CMD_STATE_INIT(this, "CMD_STATE_INIT", "3", "1", NO_COMMENT),
    CMD_STATE_REQUEST(this, "CMD_STATE_REQUEST", "3", "2", NO_COMMENT),
    CMD_STATE_RESPONSE(this, "CMD_STATE_RESPONSE", "3", "3", NO_COMMENT),
    CMD_STATE_WAIT_HALTED(this, "CMD_STATE_WAIT_HALTED", "3", "4", NO_COMMENT),
    // signals
    ...
    regidx(this, "regidx", "7", "'0", NO_COMMENT),
    wdata(this, "wdata", "32", "'0", NO_COMMENT),
    regwr(this, "regwr", "1"),
    regrd(this, "regrd", "1"),
    ...
    command(this, "command", "32", "'0", NO_COMMENT),
    autoexecdata(this, "autoexecdata", "CFG_DATA_REG_TOTAL", "'0", NO_COMMENT),
    autoexecprogbuf(this, "autoexecprogbuf", "CFG_PROGBUF_REG_TOTAL", "'0", NO_COMMENT),
    cmderr(this, "cmderr", "3", "CMDERR_NONE"),
    data0(this, "data0", "32", "'0", NO_COMMENT),
    data1(this, "data1", "32", "'0", NO_COMMENT),
    data2(this, "data2", "32", "'0", NO_COMMENT),
    data3(this, "data3", "32", "'0", NO_COMMENT),
    ...
    dport_size(this, "dport_size", "3", "'0", NO_COMMENT),
