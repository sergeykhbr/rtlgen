...
class DCacheLru : public ModuleObject {
 public:
    DCacheLru(GenObject *parent, const char *name, const char *comment=NO_COMMENT);
    ...
    class CombProcess : public ProcObject {
     public:
        CombProcess(GenObject *parent) :
            ...
            vb_line_rdata_o_wstrb(this, "vb_line_rdata_o_wstrb", "L1CACHE_BYTES_PER_LINE", "'0", NO_COMMENT),
            ...
            v_line_wflags(this, "v_line_wflags", "DTAG_FL_TOTAL", "'0", NO_COMMENT),
            ridx(this, "ridx", "SUB(CFG_LOG2_L1CACHE_BYTES_PER_LINE,3)", "'0", NO_COMMENT),
            ...
            t_req_type(this, "t_req_type", "MemopType_Total", "'0", NO_COMMENT) {
        }
