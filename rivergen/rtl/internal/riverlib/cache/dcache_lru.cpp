...
DCacheLru::DCacheLru(GenObject *parent, const char *name, const char *comment) :
    ...
    ways(this, "ways", "POW2(1,CFG_DLOG2_NWAYS)"),
    _1_(this),
    _2_(this, "State machine states:"),
    State_Idle(this, "State_Idle", "4", "0", NO_COMMENT),
    State_CheckHit(this, "State_CheckHit", "4", "1", NO_COMMENT),
    State_TranslateAddress(this, "State_TranslateAddress", "4", "2", NO_COMMENT),
    State_WaitGrant(this, "State_WaitGrant", "4", "3", NO_COMMENT),
    State_WaitResp(this, "State_WaitResp", "4", "4", NO_COMMENT),
    State_CheckResp(this, "State_CheckResp", "4", "5", NO_COMMENT),
    State_SetupReadAdr(this, "State_SetupReadAdr", "4", "6", NO_COMMENT),
    State_WriteBus(this, "State_WriteBus", "4", "7", NO_COMMENT),
    State_FlushAddr(this, "State_FlushAddr", "4", "8", NO_COMMENT),
    State_FlushCheck(this, "State_FlushCheck", "4", "9", NO_COMMENT),
    State_Reset(this, "State_Reset", "4", "10", NO_COMMENT),
    State_ResetWrite(this, "State_ResetWrite", "4", "11", NO_COMMENT),
    State_SnoopSetupAddr(this, "State_SnoopSetupAddr", "4", "12", NO_COMMENT),
    State_SnoopReadData(this, "State_SnoopReadData", "4", "13", NO_COMMENT),
    _3_(this),
    LINE_BYTES_MASK(this, "LINE_BYTES_MASK", "CFG_CPU_ADDR_BITS", "SUB(POW2(1,CFG_LOG2_L1CACHE_BYTES_PER_LINE),1)", NO_COMMENT),
    FLUSH_ALL_VALUE(this, "FLUSH_ALL_VALUE", "32", "SUB(POW2(1,ADD(CFG_DLOG2_LINES_PER_WAY,CFG_DLOG2_NWAYS)),1)", "Actual bitwidth is (ibits + waybits) but to avoid sc template generation use 32-bits"),
    // signals
    ...
    // registers
    req_type(this, "req_type", "MemopType_Total", "'0", NO_COMMENT),
    req_addr(this, "req_addr", "CFG_CPU_ADDR_BITS", "'0", NO_COMMENT),
    req_wdata(this, "req_wdata", "64", "'0", NO_COMMENT),
    req_wstrb(this, "req_wstrb", "8", "'0", NO_COMMENT),
    req_size(this, "req_size", "3", "'0", NO_COMMENT),
    state(this, "state", "4", "State_Reset"),
    req_mem_valid(this, "req_mem_valid", "1"),
    req_mem_type(this, "req_mem_type", "REQ_MEM_TYPE_BITS", "'0", NO_COMMENT),
    req_mem_size(this, "req_mem_size", "3", "'0", NO_COMMENT),
    mem_addr(this, "mem_addr", "CFG_CPU_ADDR_BITS", "'0", NO_COMMENT),
    load_fault(this, "load_fault", "1"),
    write_first(this, "write_first", "1"),
    write_flush(this, "write_flush", "1"),
    write_share(this, "write_share", "1"),
    mem_wstrb(this, "mem_wstrb", "L1CACHE_BYTES_PER_LINE", "'0", NO_COMMENT),
    ...
    req_flush_cnt(this, "req_flush_cnt", "32", "'0", NO_COMMENT),
    flush_cnt(this, "flush_cnt", "32", "'0", NO_COMMENT),
    ...
    req_addr_restore(this, "req_addr_restore", "CFG_CPU_ADDR_BITS", "'0", NO_COMMENT),
    // process
    comb(this),
    mem0(this, "mem0")
{
