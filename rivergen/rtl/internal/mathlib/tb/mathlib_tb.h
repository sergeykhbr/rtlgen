...
class mathlib_tb : public ModuleObject {
 public:
    mathlib_tb(GenObject *parent, const char *name);
...
class mathlib_tb_file : public FileObject {
 public:
    mathlib_tb_file(GenObject *parent) :
        FileObject(parent, "mathlib_tb"),
        mathlib_tb_(this, "mathlib_tb") { }

 private:
    mathlib_tb mathlib_tb_;
};
