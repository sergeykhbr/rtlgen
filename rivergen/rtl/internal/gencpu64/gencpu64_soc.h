...
class gencpu64_soc : public ModuleObject {
 public:
    gencpu64_soc(GenObject *parent, const char *name,
                const char *comment="Generic RISC-V 64-bits system");
...
class gencpu64_soc_file : public FileObject {
 public:
    gencpu64_soc_file(GenObject *parent) :
        FileObject(parent, "gencpu64_soc"),
        gencpu64_soc_(this, "gencpu64_soc") { }

 private:
    gencpu64_soc gencpu64_soc_;
};
