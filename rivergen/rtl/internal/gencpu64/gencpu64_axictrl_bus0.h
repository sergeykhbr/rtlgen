...
class gencpu64_axictrl_bus0 : public ModuleObject {
 public:
    gencpu64_axictrl_bus0(GenObject *parent, const char *name, const char *comment=NO_COMMENT);
 ...
 public:
    ...
    InStruct<types_gencpu64_bus0::bus0_xmst_out_vector> i_xmsto;
    OutStruct<types_gencpu64_bus0::bus0_xmst_in_vector> o_xmsti;
    InStruct<types_gencpu64_bus0::bus0_xslv_out_vector> i_xslvo;
    OutStruct<types_gencpu64_bus0::bus0_xslv_in_vector> o_xslvi;
    OutStruct<types_gencpu64_bus0::bus0_mapinfo_vector> o_mapinfo;
...
class gencpu64_axictrl_bus0_file : public FileObject {
 public:
    gencpu64_axictrl_bus0_file(GenObject *parent) :
        ...
        gencpu64_axictrl_bus0_(this, "gencpu64_axictrl_bus0") {}
