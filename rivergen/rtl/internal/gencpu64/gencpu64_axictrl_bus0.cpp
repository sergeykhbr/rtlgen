...
gencpu64_axictrl_bus0::gencpu64_axictrl_bus0(GenObject *parent, const char *name, const char *comment) :
    ModuleObject(parent, "gencpu64_axictrl_bus0", name, comment),
...
void gencpu64_axictrl_bus0::proc_comb() {
    GenObject *i;
    types_gencpu64_bus0::CONST_CFG_BUS0_MAP *map = 
        dynamic_cast<types_gencpu64_bus0::CONST_CFG_BUS0_MAP *>(SCV_get_cfg_type(this, "CFG_BUS0_MAP"));
