...
class hdmi_tb : public ModuleObject {
 public:
    hdmi_tb(GenObject *parent, const char *name);
...
public:
    ...
    Signal w_hdmi_irq;
    SignalStruct<types_amba::axi4_master_out_type> wb_xmsto;
    SignalStruct<types_amba::axi4_master_in_type> wb_xmsti;
...
class hdmi_tb_file : public FileObject {
 public:
    hdmi_tb_file(GenObject *parent) :
        FileObject(parent, "hdmi_tb"),
        hdmi_tb_(this, "hdmi_tb") { }
