...
apb_gpio::apb_gpio(GenObject *parent, const char *name, const char *comment) :
    ...
    // registers
    input_val(this, "input_val", "width", "'0", NO_COMMENT),
    input_en(this, "input_en", "width", "'1"),
    output_en(this, "output_en", "width", "'0", NO_COMMENT),
    output_val(this, "output_val", "width", "'0", NO_COMMENT),
    ie(this, "ie", "width", "'0", NO_COMMENT),
    ip(this, "ip", "width", "'0", NO_COMMENT),
    ...
    pslv0(this, "pslv0", NO_COMMENT)
{
    ...
    pslv0.did.setObjValue(SCV_get_cfg_type(this, "OPTIMITECH_GPIO"));
