...
accel_axi2apb_bus1::accel_axi2apb_bus1(GenObject *parent, const char *name, const char *comment) :
    ModuleObject(parent, "accel_axi2apb_bus1", name, comment),
...
void accel_axi2apb_bus1::proc_comb() {
    GenObject *i;
    types_accel_bus1::CONST_CFG_BUS1_MAP *map = 
        dynamic_cast<types_accel_bus1::CONST_CFG_BUS1_MAP *>(SCV_get_cfg_type(this, "CFG_BUS1_MAP"));
