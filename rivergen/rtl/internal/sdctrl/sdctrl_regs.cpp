...
sdctrl_regs::sdctrl_regs(GenObject *parent, const char *name, const char *comment) :
    ...
    scaler_400khz(this, "scaler_400khz", "24", "'0", NO_COMMENT),
    scaler_data(this, "scaler_data", "8", "'0", NO_COMMENT),
    scaler_cnt(this, "scaler_cnt", "32", "'0", NO_COMMENT),
    wdog(this, "wdog", "16", "0x0FFF", NO_COMMENT),
    ...
    last_req_cmd(this, "last_req_cmd", "6", "'1", NO_COMMENT),
    last_resp_cmd(this, "last_resp_cmd", "6", "'0", NO_COMMENT),
    last_resp_crc7_rx(this, "last_resp_crc7_rx", "7", "'0", NO_COMMENT),
    last_resp_crc7_calc(this, "last_resp_crc7_calc", "7", "'0", NO_COMMENT),
    last_resp_reg(this, "last_resp_reg", "32", "'0", NO_COMMENT),
    pcie_12V_support(this, "pcie_12V_support", "1", "0", NO_COMMENT),
    pcie_available(this, "pcie_available", "1", "0", NO_COMMENT),
    voltage_supply(this, "voltage_supply", "4", "0x1", NO_COMMENT),
    check_pattern(this, "check_pattern", "8", "0x55", NO_COMMENT),
    //
    comb(this),
    pslv0(this, "pslv0")
{
