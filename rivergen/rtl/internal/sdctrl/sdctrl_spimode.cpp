...
sdctrl_spimode::sdctrl_spimode(GenObject *parent, const char *name, const char *comment) :
    ...
    STATE_CMD0(this, "STATE_CMD0", "4", "0", NO_COMMENT),
    STATE_CMD8(this, "STATE_CMD8", "4", "1", NO_COMMENT),
    STATE_CMD55(this, "STATE_CMD55", "4", "2", NO_COMMENT),
    STATE_ACMD41(this, "STATE_ACMD41", "4", "3", NO_COMMENT),
    STATE_CMD58(this, "STATE_CMD58", "4", "4", NO_COMMENT),
    STATE_WAIT_DATA_REQ(this, "STATE_WAIT_DATA_REQ", "4", "5", NO_COMMENT),
    STATE_CMD17_READ_SINGLE_BLOCK(this, "STATE_CMD17_READ_SINGLE_BLOCK", "4", "6", NO_COMMENT),
    STATE_CMD24_WRITE_SINGLE_BLOCK(this, "STATE_CMD24_WRITE_SINGLE_BLOCK", "4", "7", NO_COMMENT),
    STATE_WAIT_DATA_START(this, "STATE_WAIT_DATA_START", "4", "8", NO_COMMENT),
    STATE_READING_DATA(this, "STATE_READING_DATA", "4", "9", NO_COMMENT),
    STATE_READING_CRC15(this, "STATE_READING_CRC15", "4", "10", NO_COMMENT),
    STATE_READING_END(this, "STATE_READING_END", "4", "11", NO_COMMENT),
    // signals
    // registers
    ...
    cmd_resp_r1(this, "cmd_resp_r1", "7", "'0", NO_COMMENT),
    cmd_resp_r2(this, "cmd_resp_r2", "8", "'0", NO_COMMENT),
