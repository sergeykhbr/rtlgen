...
sdctrl_cache::sdctrl_cache(GenObject *parent, const char *name, const char *comment) :
    ...
    State_SetupReadAdr(this, "State_SetupReadAdr", "4", "1", NO_COMMENT),
    State_CheckHit(this, "State_CheckHit", "4", "2", NO_COMMENT),
    State_TranslateAddress(this, "State_TranslateAddress", "4", "3", NO_COMMENT),
    State_WaitGrant(this, "State_WaitGrant", "4", "4", NO_COMMENT),
    State_WaitResp(this, "State_WaitResp", "4", "5", NO_COMMENT),
    State_CheckResp(this, "State_CheckResp", "4", "6", NO_COMMENT),
    ...
    _3_(this),
    LINE_BYTES_MASK(this, "LINE_BYTES_MASK", "CFG_SDCACHE_ADDR_BITS", "SUB(POW2(1,CFG_LOG2_SDCACHE_BYTES_PER_LINE),1)", NO_COMMENT),
    FLUSH_ALL_VALUE(this, "FLUSH_ALL_VALUE", "32", "SUB(POW2(1,ibits),1)", NO_COMMENT),
    // signals
    ...
    req_addr(this, "req_addr", "CFG_SDCACHE_ADDR_BITS", "'0", NO_COMMENT),
    ...
    mem_addr(this, "mem_addr", "CFG_SDCACHE_ADDR_BITS", "'0", NO_COMMENT),
    ...
    line_addr_i(this, "line_addr_i", "CFG_SDCACHE_ADDR_BITS", "'0", NO_COMMENT),
    cache_line_i(this, "cache_line_i", "SDCACHE_LINE_BITS", "'0", NO_COMMENT),
    cache_line_o(this, "cache_line_o", "SDCACHE_LINE_BITS", "'0", NO_COMMENT),
    // process
    comb(this),
    mem0(this, "mem0")
{
